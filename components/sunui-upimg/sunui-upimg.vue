...
<template name="sunui-upimg">
  <view class="sunui-uploader-bd">
    <view class="sunui-uploader-files">
      <block
        v-for="(item, index) in upload_before_list"
        :key="index"
        v-show="upload_before_list.length > 0"
      >
        <view
      ...
      <view
        v-show="upload_before_list.length < upload_count"
        ...
        "
      >
        <view :style="'line-height:' + upload_icon_wh + 'rpx;'"
          ><text
