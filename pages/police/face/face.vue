<template>
	<div class="face-container" @touchstart.stop="initCountTimeout">
					...
					<div v-if="currentPage == 1" class="face-register-container" @click.stop="hideModal">
						<div class="face-form-content">
							<div class="face-form-box">
								...
								<div class="face-select">
									<label>面对面民警：</label>
									<xfl-select :list="policeList" :initValue="policeInfo.value" clearable :placeholder="'请选择面对面民警'" @change="selectPolice" @clear="clearSelectPolice"></xfl-select>
								</div>
								<div class="face-select">
									<label>登记时间：</label>
								...
								<div class="face-ld-select">
									<label>面对面类型：</label>
									<ld-select ref="faceTypeRef" multiple :list="faceTypeList" label-key="value" value-key="code" :widthStyle="716" :placeholder="'请选择面对面类型'" clearable v-model="selectFaceType" @change="faceTypeChange"></ld-select>
								</div>
								<div class="face-select face-remark">
									<label>情况记录：</label>
									<textarea :value="faceRemark" :maxlength="-1" @input="faceRemarkChange" disabled></textarea>
								</div>
							</div>
						</div>
					...
					<div v-if="currentPage == 2" class="face-record-container">
						<div class="record-form-content">
							<div class="face-form-box">
								...
								<div class="face-select">
									<label>面对面类型：</label>
									<xfl-select :list="faceTypeList" clearable :placeholder="'请选择面对面类型'" @change="faceTypeSearch" @clear="clearFaceType"></xfl-select>
								</div>
							</div>
							<div class="face-button-box">
						...
						<div class="record-table-box">
							<div class="table-head">
								<div class="table-head-item" v-for="(item, index) in faceColumns" :key="index" :style="{ flex: item.flex }">
									{{ item.title }}
								</div>
							</div>
