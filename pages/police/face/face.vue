          ...
          <div v-if="currentPage == 1" class="face-register-container">
            <div class="face-form-content">
              <div class="face-form-box">
                ...
                <div class="face-select">
                  <label>面对面民警：</label>
                  <xfl-select :list="policeList" clearable :placeholder="'请选择面对面民警'" @change="selectPolice" @clear="clearSelectPolice"></xfl-select>
                </div>
                <div class="face-select">
                  <label>登记时间：</label>
                ...
                <div class="face-select">
                  <label>面对面类型：</label>
                  <xfl-select :list="faceTypeList" clearable :placeholder="'请选择面对面类型'" @change="selectFaceType" @clear="clearFaceType"></xfl-select>
                </div>
