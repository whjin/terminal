          ...
          <scroll-view scroll-y="true" class="shopping-goods-scroll">
            <div class="shopping-goods-box">
              <div
                ...
                v-for="item in foodGoodsList"
                :key="item.id"
                @click="handleSelectGoods(item)"
              >
                <div class="goods-img">
                  <image
                    :src="item.image ? fileUrlPrefix + item.image : defaultUrl"
                  ></image>
                </div>
